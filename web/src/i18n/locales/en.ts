const en = {
  ...
  "licenses.copyKey": "Copy license key",
  "licenses.keyUnavailable": "Could not retrieve the license key.",
  "licenses.keyCopyFailed": "Could not copy to the clipboard. Open the license to see the key.",
